...
@section('content')
        <div class="container-fluid m-0 p-0">
            ...
            <div class="row m-0">
                    <div class="col-4">
                        <div style="font-weight:bold;box-sizing: border-box;display: flex;padding: 2rem;flex-flow: column;justify-content: center ;">
                            <h5><strong>社團簡介</strong></h5>
                            <div style="width: 100%;padding: 2rem;box-sizing: border-box;display: flex;flex-flow: column;justify-content: center;">
                    ...
                    <div class="col-8 p-0">
                        <div class="image-3x4" style="background-image: url(../../img/club.jpg);height:100%;width:auto;">
        ...
        <div class="tab-pane fade" id="nav-class" role="tabpanel" aria-labelledby="nav-class-tab">
            ...
            <div class="card mb-3 bg m-3" data-toggle="modal" data-target="<?php echo "#".$modal ?>">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">{{ $r -> class_name }}</h5>
        ...
        <div class="tab-pane fade" id="nav-result" role="tabpanel" aria-labelledby="nav-result-tab">
            ...
            <div class="card mb-3 bg m-3" data-toggle="modal" data-target="<?php echo "#".$modal ?>">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">{{ $a -> activity_name }}</h5>
                            <p class="card-text">{{ $a -> date }}</p>
                            <p class="card-text">{{ $a -> activity_mainpoint }}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade c0 " id="<?php echo $modal ?>" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content bg-d">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="<?php echo $modal."Title" ?>">{{ $a -> activity_name }}</h5>
                                    <button type="button" class="close bg-d c0" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <div class="container">
                                        <div class="row d-flex text-start">
                                            <p>活動日期：{{ $a -> date }}</p>
                                            <p>活動地點：{{ $a -> activity_venue }}</p>
                                            <span style="padding-left: 12px;padding: right 12px;">
                                            <p>活動內容：</p>
                                            <div style="padding-left: 12px;padding: right 12px;">{{ $a -> activity_mainpoint }}
                                            </div> </span>
                                        </div>
                                        <hr></hr>
