   ...
   /**
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasFile('club_show_pic')){
            ...
            $fileNameToStore= $filename.'_'.time().'.'.$extension;
            // Upload Image
            $path = $request->file('club_show_pic')->storeAs('public/club/', $fileNameToStore);
        ...
        if($request->hasFile('club_cover')){
            ...
            $fileNameToStore= $filename.'_'.time().'.'.$extension;
            // Upload Image
            $path = $request->file('club_cover')->storeAs('public/club/', $fileNameToStore);
        ...
        $club->club_cover=$request->input('club_cover');
        $club->club_icon=$request->input('club_icon');
        $club->save();
        ...
        $club_semester->club_show_pic=$request->input('club_show_pic');
        $club_semester->save();
